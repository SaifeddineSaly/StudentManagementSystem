...
urlpatterns = [
    ...
    path('admin_view_result/', HodViews.admin_view_result, name='admin_view_result'),
    path('process_selected_value/', HodViews.process_selected_value, name='process_selected_value'),
    path('get_courses_for_major/', HodViews.get_courses_for_major, name='get_courses_for_major'),
    path('api/get_staffs_for_course/', HodViews.get_staffs_for_course, name='get_staffs_for_course'),
    path('get_result', HodViews.get_result, name='get_result'),
    path('get_result_last_dance', HodViews.get_result_last_dance, name='get_result_last_dance'),
    path('delete-data-staff-from-chef', HodViews.delete_data_staff, name='delete_data_staff'),
    path('delete-data-staff-from-chef/<int:data_id>/', HodViews.delete_data_staff, name='delete_data_staff'),
    path('delete-data-student-from-chef/<int:data_id>/', HodViews.delete_data_student, name='delete_data_student'),
    path('get_student_results_last/', HodViews.get_student_results_last, name='get_student_results_last'),
    # path('delete-data-staff-from-chef-leave/<int:data_id>/', HodViews.delete_data_staff_leave, name='delete_data_staff_leave'),
    # path('get_subjects_for_course/', HodViews.get_subjects_for_course, name='get_subjects_for_course'),
    ...
    path('delete-data/<int:data_id>/', StaffViews.delete_data, name='delete_data'),
    # path('base_template.html/', HodViews.staff_show_notification, name='staff_show_notification'),
    ...
    path('delete-data-2/<int:data_id>/', StudentViews.delete_data, name='delete_data'),
    path('delete-data-result/<int:data_id>/', StudentViews.delete_data_result, name='delete-data-result'),
]
